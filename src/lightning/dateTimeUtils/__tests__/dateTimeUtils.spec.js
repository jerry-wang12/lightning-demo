...
describe('normalizeISODate', () => {
    it('formats an ISO formatted date string', () => {
        ...
        expect(normalizedValue.displayValue).toBe('2018/09/10');
...
describe('normalizeISOTime', () => {
    it('formats an ISO formatted time string', () => {
        ...
        expect(normalizedValue.displayValue).toBe('11:23 AM');
...
describe('normalizeISODateTime', () => {
    it('formats an ISO formatted datetime string', () => {
        ...
        // The stubs assume that the timezone is 1 hour behind UTC
        expect(normalizedValue.displayValue).toBe('2018/09/10 10:23 AM');
        expect(normalizedValue.isoValue).toBe('2018-09-10T10:23:44.222');
    });
    ...
    it('formats an ISO formatted datetime string without seconds', () => {
        ...
        // The stubs assume that the timezone is 1 hour behind UTC
        expect(normalizedValue.displayValue).toBe('2018/09/10 10:23 AM');
        expect(normalizedValue.isoValue).toBe('2018-09-10T10:23:00.000');
    });
...
describe('normalizeFormattedDate', () => {
    it('converts a formatted date string to ISO', () => {
        const normalizedValue = normalizeFormattedDate('2018/09/10');
...
describe('normalizeFormattedTime', () => {
    it('converts a formatted time string to ISO', () => {
        const normalizedValue = normalizeFormattedTime('11:23');
...
describe('normalizeFormattedDateTime', () => {
    it('converts a formatted datetime string to ISO', () => {
        const normalizedValue = normalizeFormattedDateTime('2018/09/10 11:23');
