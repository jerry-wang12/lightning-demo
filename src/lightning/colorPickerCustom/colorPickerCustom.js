...
export default class LightningColorPickerCustom extends LightningElement {
    ...
    get gradientStyle() {
        return `background: ${this.state.hex ||
    ...
    handleRgbChange(event) {
        const value = this.parseAndLimit(event.currentTarget.value);
        ...
        if (event.currentTarget.getAttribute('data-color-name') === 'red') {
            ...
            event.currentTarget.getAttribute('data-color-name') === 'green'
        ) {
            this.state.rgb.green = value;
        } else if (
            event.currentTarget.getAttribute('data-color-name') === 'blue'
        ) {
    ...
    handleHexChange(event) {
        ...
        if (isInputValid) {
            ...
            this.state.errorMessage = getErrorMessage(
                event.srcElement.validity,
                {
    ...
    getColorFromGradient(event) {
        ...
        this.setCanvasColor(this.state.hueValue);
